...
import type { PageResponse, Trade } from "../types";
...
export function TradesPage() {
  ...
  const { data, error } = useApi<PageResponse<"trades", Trade>>(`/api/trades?page=${page}&pageSize=${PAGE_SIZE}`, 15_000);
